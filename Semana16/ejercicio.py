...
alumno1 = (1, "Rouse Jackson", 8, "Ingles")
alumno2 = (2, "Jackson Dousen", 4, "Natacion")
Alumno3 = (3, "Maide Icerber", 10, "boxeo")
alumno4 = (4, "Jhonatan Wick", 9, "Danza moderna")
alumno5 = (5, "Neimar del nombre de Jesus ", 10, "Actuacion")
Alumno6 = (6, "Nicolas Tesla", 10, "electricidad")
